...
fn verification_fails_with_wrong_public_key() {
    let privkey = sample_privkey();
    let wrong_privkey = Signature::load_privkey_from_hex(
        "1e99423a4ed27608a15a2616e25f98a9146f8b95f30f9f2bb8f3b7f6a67d7d4b",
    )
    .expect("wrong private key fixture must be valid");
